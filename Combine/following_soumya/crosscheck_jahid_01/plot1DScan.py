...
def BuildScan(scan, param, files, color, yvals, ycut):
    ...
    func.SetLineWidth(3)
    print("bestfit is not None : ", bestfit is not None)
...
print("BuildScan(args.output, args.POI, [args.main], args.main_color, yvals, args.y_cut) : ",args.output, args.POI, [args.main], args.main_color, yvals, args.y_cut ) 
