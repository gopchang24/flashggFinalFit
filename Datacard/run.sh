...
#python RunYields.py --inputWSDirMap 2017=/afs/cern.ch/user/c/chjoo/eos_workspace/higgs_ac_ggh_hgg/finalfit/data_finalfit/220804_htot_rename/mc/ws_GG2H --cats ac_0J,ac_1J,ac_2J,ac_ptH --procs auto --batch condor --queue longlunch --mergeYears
