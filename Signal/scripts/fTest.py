...
for proc in opt.procs.split(","):
  ...
  print( "input WS is inputWS.data(%s_____%s_____%s_____%s)"%(procToData(proc.split("_")[0]),opt.mass,sqrts__,opt.cat))
  print( "inputWS is %s"%inputWS.data("%s_%s_%s_%s"%(procToData(proc.split("_")[0]),opt.mass,sqrts__,opt.cat)) )
