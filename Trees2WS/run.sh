...
python trees2ws.py --inputConfig config_simple.py  --inputTreeFile /afs/cern.ch/user/c/chjoo/eos_workspace/higgs_ac_ggh_hgg/finalfit/data_finalfit/220914_following_soumya/MELA_ntuples_ggF/output_JJHiggs0PMToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8_MELA.root --productionMode ggh --year 2017
# for background
